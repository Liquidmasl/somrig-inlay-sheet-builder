...
| `tests/e2e/whats-new.spec.ts` | What's New reopening from the header, photo carousel |
...
| `.claude/3mf-export.md` | 3MF pipeline, per-colour grouping, Bambu colour handling |
